...

{
    ...
    'version': '13.0.1.0.0',
    'category': 'Tools',
    'summary': "As Consultor for v13 CE",
    'author': "SISE Servicios by jeo Software",
    'website': 'http://github.com/sebatista/cl-asc',
    'license': 'AGPL-3',
    'depends': [
        'standard_depends_ce'
        ],
    ...
    'git-repos': [
        # Maín git repository
        # ===================
        'https://github.com/sebatista/cl-asc.git',


        # Jobiols Private Repos
        # =====================
